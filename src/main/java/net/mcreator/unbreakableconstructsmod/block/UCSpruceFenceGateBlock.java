...
public class UCSpruceFenceGateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_spruce_fence_gate")
	public static final Block block = null;

	public UCSpruceFenceGateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 418);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_spruce_fence_gate");
		}
