...
public class ChiseledQuartzBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:chiseled_quartz_block")
	public static final Block block = null;

	public ChiseledQuartzBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("chiseled_quartz_block");
		}
