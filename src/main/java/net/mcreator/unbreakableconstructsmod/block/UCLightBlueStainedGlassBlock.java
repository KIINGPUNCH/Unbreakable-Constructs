...
public class UCLightBlueStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_light_blue_stained_glass")
	public static final Block block = null;

	public UCLightBlueStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 172);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_light_blue_stained_glass");
		}
