...
public class UCLitRespawnAnchor3Block extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lit_respawn_anchor_3")
	public static final Block block = null;

	public UCLitRespawnAnchor3Block(UnbreakableConstructsModModElements instance) {
		super(instance, 391);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 11));
			setRegistryName("uc_lit_respawn_anchor_3");
		}
