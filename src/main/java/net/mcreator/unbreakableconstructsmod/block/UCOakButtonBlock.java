...
public class UCOakButtonBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_button")
	public static final Block block = null;

	public UCOakButtonBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 428);
	}
