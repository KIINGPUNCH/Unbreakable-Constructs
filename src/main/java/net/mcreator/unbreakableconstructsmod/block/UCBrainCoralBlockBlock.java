...
public class UCBrainCoralBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_brain_coral_block")
	public static final Block block = null;

	public UCBrainCoralBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.CORAL).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_brain_coral_block");
		}
