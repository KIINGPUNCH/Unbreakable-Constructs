...
public class UCSpruceLeavesBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_spruce_leaves")
	public static final Block block = null;

	public UCSpruceLeavesBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 286);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_spruce_leaves");
		}
