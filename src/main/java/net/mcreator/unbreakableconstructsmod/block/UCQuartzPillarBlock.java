...
public class UCQuartzPillarBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_quartz_pillar")
	public static final Block block = null;

	public UCQuartzPillarBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 145);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_quartz_pillar");
		}
