...
public class UCYellowShulkerBoxBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_yellow_shulker_box")
	public static final Block block = null;

	public UCYellowShulkerBoxBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 343);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_yellow_shulker_box");
		}
