...
public class UCCartographyTableBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_cartography_table")
	public static final Block block = null;

	public UCCartographyTableBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 377);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_cartography_table");
		}
