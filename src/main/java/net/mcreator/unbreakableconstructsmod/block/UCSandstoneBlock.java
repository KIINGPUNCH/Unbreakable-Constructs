...
public class UCSandstoneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_sandstone")
	public static final Block block = null;

	public UCSandstoneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 51);
	}
