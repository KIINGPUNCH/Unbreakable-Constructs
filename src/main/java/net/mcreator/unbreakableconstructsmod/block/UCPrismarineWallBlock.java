...
public class UCPrismarineWallBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_prismarine_wall")
	public static final Block block = null;

	public UCPrismarineWallBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 309);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_prismarine_wall");
		}
