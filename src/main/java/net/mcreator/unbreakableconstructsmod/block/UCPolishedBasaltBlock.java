...
public class UCPolishedBasaltBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_polished_basalt")
	public static final Block block = null;

	public UCPolishedBasaltBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.BASALT).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_polished_basalt");
		}
