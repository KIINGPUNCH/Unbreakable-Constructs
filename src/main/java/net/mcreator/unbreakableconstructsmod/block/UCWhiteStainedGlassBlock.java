...
public class UCWhiteStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_white_stained_glass")
	public static final Block block = null;

	public UCWhiteStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_white_stained_glass");
		}
