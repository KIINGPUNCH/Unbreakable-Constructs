...
public class UCChainCommandBlockConditionalBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_chain_command_block_conditional")
	public static final Block block = null;

	public UCChainCommandBlockConditionalBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 458);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_chain_command_block_conditional");
		}
