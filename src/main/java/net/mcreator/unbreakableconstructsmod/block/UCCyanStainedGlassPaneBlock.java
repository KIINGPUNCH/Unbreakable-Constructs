...
public class UCCyanStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_cyan_stained_glass_pane")
	public static final Block block = null;

	public UCCyanStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 331);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_cyan_stained_glass_pane");
		}
