...
public class UCRedstoneLampBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_redstone_lamp")
	public static final Block block = null;

	public UCRedstoneLampBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 425);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.GLASS).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_redstone_lamp");
		}
