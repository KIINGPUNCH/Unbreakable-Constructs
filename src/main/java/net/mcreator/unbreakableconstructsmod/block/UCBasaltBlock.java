...
public class UCBasaltBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_basalt")
	public static final Block block = null;

	public UCBasaltBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 116);
	}
