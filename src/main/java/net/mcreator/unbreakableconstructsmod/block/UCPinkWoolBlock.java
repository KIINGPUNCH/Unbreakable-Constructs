...
public class UCPinkWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_pink_wool")
	public static final Block block = null;

	public UCPinkWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 60);
	}
