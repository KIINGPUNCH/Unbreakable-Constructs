...
public class UCRedConcreteBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_red_concrete")
	public static final Block block = null;

	public UCRedConcreteBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 215);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_red_concrete");
		}
