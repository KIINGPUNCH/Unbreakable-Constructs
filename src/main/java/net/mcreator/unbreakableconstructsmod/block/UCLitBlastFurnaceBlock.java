...
public class UCLitBlastFurnaceBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lit_blast_furnace")
	public static final Block block = null;

	public UCLitBlastFurnaceBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 376);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_lit_blast_furnace");
		}
