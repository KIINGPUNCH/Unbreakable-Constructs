...
public class UCMossyCobblestoneStairsBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_mossy_cobblestone_stairs")
	public static final Block block = null;

	public UCMossyCobblestoneStairsBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 246);
	}
		...
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE)
					...
					Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
							.setLightLevel(s -> 0));
			setRegistryName("uc_mossy_cobblestone_stairs");
		}
