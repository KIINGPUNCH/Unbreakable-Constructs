...
public class UCGoldOreBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_gold_ore")
	public static final Block block = null;

	public UCGoldOreBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 26);
	}
