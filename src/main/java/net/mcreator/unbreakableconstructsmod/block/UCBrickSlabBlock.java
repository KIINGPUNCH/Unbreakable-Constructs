...
public class UCBrickSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_brick_slab")
	public static final Block block = null;

	public UCBrickSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 85);
	}
