...
public class UCWhiteWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_white_wool")
	public static final Block block = null;

	public UCWhiteWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 54);
	}
