...
public class UCBlockOfNetheriteBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_block_of_netherite")
	public static final Block block = null;

	public UCBlockOfNetheriteBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 270);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.NETHERITE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_block_of_netherite");
		}
