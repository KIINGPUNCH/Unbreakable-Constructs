...
public class UCWarpedDoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_warped_door")
	public static final Block block = null;

	public UCWarpedDoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 452);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_warped_door");
		}
