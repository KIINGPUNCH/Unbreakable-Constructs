...
public class UCBrownShulkerBoxBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_brown_shulker_box")
	public static final Block block = null;

	public UCBrownShulkerBoxBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 351);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_brown_shulker_box");
		}
