...
public class UCLimeGlazedTerracottaBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lime_glazed_terracotta")
	public static final Block block = null;

	public UCLimeGlazedTerracottaBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 360);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_lime_glazed_terracotta");
		}
