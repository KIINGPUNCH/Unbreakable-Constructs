...
public class UCBrownWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_brown_wool")
	public static final Block block = null;

	public UCBrownWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 66);
	}
