...
public class UCBreakableSmokerBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_breakable_smoker")
	public static final Block block = null;

	public UCBreakableSmokerBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 469);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_breakable_smoker");
		}
