...
public class UCMossyStoneBricksBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_mossy_stone_bricks")
	public static final Block block = null;

	public UCMossyStoneBricksBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 121);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_mossy_stone_bricks");
		}
