...
public class UCWarpedTrapdoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_warped_trapdoor")
	public static final Block block = null;

	public UCWarpedTrapdoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 416);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_warped_trapdoor");
		}
