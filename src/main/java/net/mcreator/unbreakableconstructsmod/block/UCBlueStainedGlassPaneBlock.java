...
public class UCBlueStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blue_stained_glass_pane")
	public static final Block block = null;

	public UCBlueStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 333);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_blue_stained_glass_pane");
		}
