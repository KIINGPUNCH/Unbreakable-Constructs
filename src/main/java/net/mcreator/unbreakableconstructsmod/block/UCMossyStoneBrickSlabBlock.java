...
public class UCMossyStoneBrickSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_mossy_stone_brick_slab")
	public static final Block block = null;

	public UCMossyStoneBrickSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 258);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_mossy_stone_brick_slab");
		}
