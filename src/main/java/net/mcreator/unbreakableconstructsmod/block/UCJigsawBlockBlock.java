...
public class UCJigsawBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jigsaw_block")
	public static final Block block = null;

	public UCJigsawBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 466);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_jigsaw_block");
		}
