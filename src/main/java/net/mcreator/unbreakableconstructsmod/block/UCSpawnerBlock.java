...
public class UCSpawnerBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_spawner")
	public static final Block block = null;

	public UCSpawnerBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 454);
	}
