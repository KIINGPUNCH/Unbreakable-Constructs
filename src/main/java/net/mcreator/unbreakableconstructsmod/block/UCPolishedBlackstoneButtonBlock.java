...
public class UCPolishedBlackstoneButtonBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_polished_blackstone_button")
	public static final Block block = null;

	public UCPolishedBlackstoneButtonBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 436);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_polished_blackstone_button");
		}
