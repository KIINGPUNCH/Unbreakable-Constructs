...
public class UCCrimsonButtonBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_crimson_button")
	public static final Block block = null;

	public UCCrimsonButtonBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 434);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_crimson_button");
		}
