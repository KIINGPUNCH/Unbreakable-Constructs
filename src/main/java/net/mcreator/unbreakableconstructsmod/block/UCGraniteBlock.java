...
public class UCGraniteBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_granite")
	public static final Block block = null;

	public UCGraniteBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 2);
	}
