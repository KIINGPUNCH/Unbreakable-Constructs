...
public class UCCrimsonDoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_crimson_door")
	public static final Block block = null;

	public UCCrimsonDoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 451);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_crimson_door");
		}
