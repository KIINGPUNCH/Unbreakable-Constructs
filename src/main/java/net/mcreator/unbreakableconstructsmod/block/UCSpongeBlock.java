...
public class UCSpongeBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_sponge")
	public static final Block block = null;

	public UCSpongeBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 46);
	}
