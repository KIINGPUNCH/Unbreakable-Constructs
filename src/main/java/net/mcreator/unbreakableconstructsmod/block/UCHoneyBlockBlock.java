...
public class UCHoneyBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_honey_block")
	public static final Block block = null;

	public UCHoneyBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 385);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_honey_block");
		}
