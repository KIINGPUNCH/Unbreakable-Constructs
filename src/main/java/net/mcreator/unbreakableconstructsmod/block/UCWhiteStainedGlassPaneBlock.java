...
public class UCWhiteStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_white_stained_glass_pane")
	public static final Block block = null;

	public UCWhiteStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 322);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_white_stained_glass_pane");
		}
