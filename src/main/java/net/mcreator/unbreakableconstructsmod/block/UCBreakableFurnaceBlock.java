...
public class UCBreakableFurnaceBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_breakable_furnace")
	public static final Block block = null;

	public UCBreakableFurnaceBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 467);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(1f, 3.5f)
					.setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("uc_breakable_furnace");
		}
