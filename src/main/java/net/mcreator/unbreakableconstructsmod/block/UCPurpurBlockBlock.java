...
public class UCPurpurBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_purpur_block")
	public static final Block block = null;

	public UCPurpurBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_purpur_block");
		}
