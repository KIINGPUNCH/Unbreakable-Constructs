...
public class UCCrimsonStairsBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_crimson_stairs")
	public static final Block block = null;

	public UCCrimsonStairsBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 139);
	}
		...
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD)
					...
					Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
							.setLightLevel(s -> 0));
			setRegistryName("uc_crimson_stairs");
		}
