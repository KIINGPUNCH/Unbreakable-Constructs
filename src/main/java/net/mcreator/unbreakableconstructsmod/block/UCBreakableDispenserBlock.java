...
public class UCBreakableDispenserBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_breakable_dispenser")
	public static final Block block = null;

	public UCBreakableDispenserBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 470);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_breakable_dispenser");
		}
