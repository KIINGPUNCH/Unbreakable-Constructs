...
public class UCBricksBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_bricks")
	public static final Block block = null;

	public UCBricksBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 96);
	}
