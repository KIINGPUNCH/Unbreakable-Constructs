...
public class UCOakSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_slab")
	public static final Block block = null;

	public UCOakSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 72);
	}
