...
public class UCStrippedWarpedStemBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stripped_warped_stem")
	public static final Block block = null;

	public UCStrippedWarpedStemBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_stripped_warped_stem");
		}
