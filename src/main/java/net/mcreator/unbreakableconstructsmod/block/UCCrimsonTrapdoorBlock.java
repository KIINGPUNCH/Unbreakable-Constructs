...
public class UCCrimsonTrapdoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_crimson_trapdoor")
	public static final Block block = null;

	public UCCrimsonTrapdoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 415);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_crimson_trapdoor");
		}
