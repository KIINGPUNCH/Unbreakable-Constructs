...
public class UCDioriteBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_diorite")
	public static final Block block = null;

	public UCDioriteBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 4);
	}
