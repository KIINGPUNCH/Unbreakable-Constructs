...
public class UCBreakableShulkerBoxBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_breakable_shulker_box")
	public static final Block block = null;

	public UCBreakableShulkerBoxBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 473);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.SHULKER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(2f, 2f)
					.setLightLevel(s -> 0));
			setRegistryName("uc_breakable_shulker_box");
		}
