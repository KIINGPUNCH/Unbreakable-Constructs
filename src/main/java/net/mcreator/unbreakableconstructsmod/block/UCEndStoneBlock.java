...
public class UCEndStoneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_end_stone")
	public static final Block block = null;

	public UCEndStoneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 131);
	}
