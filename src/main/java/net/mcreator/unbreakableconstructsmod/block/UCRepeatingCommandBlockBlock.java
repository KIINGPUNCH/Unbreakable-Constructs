...
public class UCRepeatingCommandBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_repeating_command_block")
	public static final Block block = null;

	public UCRepeatingCommandBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 459);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_repeating_command_block");
		}
