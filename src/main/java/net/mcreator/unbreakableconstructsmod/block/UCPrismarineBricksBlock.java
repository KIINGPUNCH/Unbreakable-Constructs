...
public class UCPrismarineBricksBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_prismarine_bricks")
	public static final Block block = null;

	public UCPrismarineBricksBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 186);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_prismarine_bricks");
		}
