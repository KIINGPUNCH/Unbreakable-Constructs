...
public class UCLoomBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_loom")
	public static final Block block = null;

	public UCLoomBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 371);
	}
