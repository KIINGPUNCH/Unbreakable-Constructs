...
public class UCOrangeTerracottaBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_orange_terracotta")
	public static final Block block = null;

	public UCOrangeTerracottaBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 148);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_orange_terracotta");
		}
