...
public class UCSoulSandBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_soul_sand")
	public static final Block block = null;

	public UCSoulSandBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 114);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.SOUL_SAND).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_soul_sand");
		}
