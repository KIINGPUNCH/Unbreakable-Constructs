...
public class UCBlueShulkerBoxBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blue_shulker_box")
	public static final Block block = null;

	public UCBlueShulkerBoxBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 350);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_blue_shulker_box");
		}
