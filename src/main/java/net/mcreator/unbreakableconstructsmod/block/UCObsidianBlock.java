...
public class UCObsidianBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_obsidian")
	public static final Block block = null;

	public UCObsidianBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 99);
	}
