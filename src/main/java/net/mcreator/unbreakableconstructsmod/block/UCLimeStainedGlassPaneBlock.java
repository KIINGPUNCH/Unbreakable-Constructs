...
public class UCLimeStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lime_stained_glass_pane")
	public static final Block block = null;

	public UCLimeStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 327);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_lime_stained_glass_pane");
		}
