...
public class UCPodzolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_podzol")
	public static final Block block = null;

	public UCPodzolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 11);
	}
