...
public class UCJungleTrapdoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jungle_trapdoor")
	public static final Block block = null;

	public UCJungleTrapdoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 412);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_jungle_trapdoor");
		}
