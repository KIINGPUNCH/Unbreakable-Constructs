...
public class UCCarvedPumpkinBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_carved_pumpkin")
	public static final Block block = null;

	public UCCarvedPumpkinBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_carved_pumpkin");
		}
