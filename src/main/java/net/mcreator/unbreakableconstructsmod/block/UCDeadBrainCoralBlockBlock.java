...
public class UCDeadBrainCoralBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dead_brain_coral_block")
	public static final Block block = null;

	public UCDeadBrainCoralBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 234);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_dead_brain_coral_block");
		}
