...
public class UCStoneSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stone_slab")
	public static final Block block = null;

	public UCStoneSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 80);
	}
