...
public class UCGrayTerracottaBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_gray_terracotta")
	public static final Block block = null;

	public UCGrayTerracottaBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 154);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_gray_terracotta");
		}
