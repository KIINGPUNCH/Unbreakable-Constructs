...
public class UCCrackedPolishedBlackstoneBricksBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_cracked_polished_blackstone_bricks")
	public static final Block block = null;

	public UCCrackedPolishedBlackstoneBricksBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 284);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_cracked_polished_blackstone_bricks");
		}
