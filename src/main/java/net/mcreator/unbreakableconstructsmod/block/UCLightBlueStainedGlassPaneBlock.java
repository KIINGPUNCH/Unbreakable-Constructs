...
public class UCLightBlueStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_light_blue_stained_glass_pane")
	public static final Block block = null;

	public UCLightBlueStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 325);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_light_blue_stained_glass_pane");
		}
