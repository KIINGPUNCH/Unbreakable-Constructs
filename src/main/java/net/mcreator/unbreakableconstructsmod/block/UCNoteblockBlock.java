...
public class UCNoteblockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_noteblock")
	public static final Block block = null;

	public UCNoteblockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 395);
	}
