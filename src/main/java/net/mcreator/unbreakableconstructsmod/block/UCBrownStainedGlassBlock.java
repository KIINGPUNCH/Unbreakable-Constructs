...
public class UCBrownStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_brown_stained_glass")
	public static final Block block = null;

	public UCBrownStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 181);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_brown_stained_glass");
		}
