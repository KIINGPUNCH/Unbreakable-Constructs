...
public class UCMelonBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_melon")
	public static final Block block = null;

	public UCMelonBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 124);
	}
