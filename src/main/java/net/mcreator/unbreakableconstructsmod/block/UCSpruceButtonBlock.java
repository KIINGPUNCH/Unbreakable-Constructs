...
public class UCSpruceButtonBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_spruce_button")
	public static final Block block = null;

	public UCSpruceButtonBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 429);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_spruce_button");
		}
