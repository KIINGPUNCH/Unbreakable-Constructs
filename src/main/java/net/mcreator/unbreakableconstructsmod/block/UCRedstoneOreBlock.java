...
public class UCRedstoneOreBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_redstone_ore")
	public static final Block block = null;

	public UCRedstoneOreBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_redstone_ore");
		}
