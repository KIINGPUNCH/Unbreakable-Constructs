...
public class UCBirchSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_birch_slab")
	public static final Block block = null;

	public UCBirchSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 74);
	}
