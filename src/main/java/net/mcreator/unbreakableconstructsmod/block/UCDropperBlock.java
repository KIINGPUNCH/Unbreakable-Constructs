...
public class UCDropperBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dropper")
	public static final Block block = null;

	public UCDropperBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 440);
	}
