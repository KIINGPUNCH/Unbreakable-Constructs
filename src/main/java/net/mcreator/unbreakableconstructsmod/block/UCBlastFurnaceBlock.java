...
public class UCBlastFurnaceBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blast_furnace")
	public static final Block block = null;

	public UCBlastFurnaceBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 375);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_blast_furnace");
		}
