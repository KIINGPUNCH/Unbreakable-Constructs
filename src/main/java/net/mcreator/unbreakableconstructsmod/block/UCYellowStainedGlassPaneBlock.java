...
public class UCYellowStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_yellow_stained_glass_pane")
	public static final Block block = null;

	public UCYellowStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 326);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_yellow_stained_glass_pane");
		}
