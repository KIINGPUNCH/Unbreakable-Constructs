...
public class UCMagentaStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_magenta_stained_glass")
	public static final Block block = null;

	public UCMagentaStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 171);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_magenta_stained_glass");
		}
