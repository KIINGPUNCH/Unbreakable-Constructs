...
public class UCLightGrayConcreteBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_light_gray_concrete")
	public static final Block block = null;

	public UCLightGrayConcreteBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 209);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_light_gray_concrete");
		}
