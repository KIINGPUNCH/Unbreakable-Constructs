...
public class UCNetherrackBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_netherrack")
	public static final Block block = null;

	public UCNetherrackBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 113);
	}
