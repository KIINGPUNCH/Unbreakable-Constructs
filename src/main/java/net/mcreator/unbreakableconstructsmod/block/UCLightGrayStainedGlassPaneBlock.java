...
public class UCLightGrayStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_light_gray_stained_glass_pane")
	public static final Block block = null;

	public UCLightGrayStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 330);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_light_gray_stained_glass_pane");
		}
