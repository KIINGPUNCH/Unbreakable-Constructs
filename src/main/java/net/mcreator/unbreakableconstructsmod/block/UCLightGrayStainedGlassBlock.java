...
public class UCLightGrayStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_light_gray_stained_glass")
	public static final Block block = null;

	public UCLightGrayStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_light_gray_stained_glass");
		}
