...
public class UCBoneBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_bone_block")
	public static final Block block = null;

	public UCBoneBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.BONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_bone_block");
		}
