...
public class UCWarpedSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_warped_slab")
	public static final Block block = null;

	public UCWarpedSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_warped_slab");
		}
