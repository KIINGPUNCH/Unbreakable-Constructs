...
public class UCStonePressurePlateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stone_pressure_plate")
	public static final Block block = null;

	public UCStonePressurePlateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 399);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_stone_pressure_plate");
		}
