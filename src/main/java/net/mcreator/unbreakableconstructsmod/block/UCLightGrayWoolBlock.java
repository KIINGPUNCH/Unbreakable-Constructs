...
public class UCLightGrayWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_light_gray_wool")
	public static final Block block = null;

	public UCLightGrayWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.CLOTH).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_light_gray_wool");
		}
