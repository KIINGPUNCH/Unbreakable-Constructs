...
public class UCWarpedWartBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_warped_wart_block")
	public static final Block block = null;

	public UCWarpedWartBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 198);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.NETHER_WART).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_warped_wart_block");
		}
