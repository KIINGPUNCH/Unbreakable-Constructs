...
public class UCSlimeBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_slime_block")
	public static final Block block = null;

	public UCSlimeBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 321);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.SLIME).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("uc_slime_block");
		}
