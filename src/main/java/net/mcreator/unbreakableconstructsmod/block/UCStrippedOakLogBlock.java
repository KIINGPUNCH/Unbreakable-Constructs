...
public class UCStrippedOakLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stripped_oak_log")
	public static final Block block = null;

	public UCStrippedOakLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_stripped_oak_log");
		}
