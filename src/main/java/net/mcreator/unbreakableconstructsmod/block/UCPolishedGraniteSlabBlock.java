...
public class UCPolishedGraniteSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_polished_granite_slab")
	public static final Block block = null;

	public UCPolishedGraniteSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 256);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_polished_granite_slab");
		}
