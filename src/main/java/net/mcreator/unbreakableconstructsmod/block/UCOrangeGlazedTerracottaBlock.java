...
public class UCOrangeGlazedTerracottaBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_orange_glazed_terracotta")
	public static final Block block = null;

	public UCOrangeGlazedTerracottaBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 356);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_orange_glazed_terracotta");
		}
