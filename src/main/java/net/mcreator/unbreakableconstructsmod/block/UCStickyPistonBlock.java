...
public class UCStickyPistonBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_sticky_piston")
	public static final Block block = null;

	public UCStickyPistonBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 396);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_sticky_piston");
		}
