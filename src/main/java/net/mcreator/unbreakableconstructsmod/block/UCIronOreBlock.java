...
public class UCIronOreBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_iron_ore")
	public static final Block block = null;

	public UCIronOreBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 27);
	}
