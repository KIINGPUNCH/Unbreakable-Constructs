...
public class UCBlueWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blue_wool")
	public static final Block block = null;

	public UCBlueWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 65);
	}
