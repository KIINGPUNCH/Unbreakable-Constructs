...
public class UCBlockofIronBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blockof_iron")
	public static final Block block = null;

	public UCBlockofIronBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.METAL).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_blockof_iron");
		}
