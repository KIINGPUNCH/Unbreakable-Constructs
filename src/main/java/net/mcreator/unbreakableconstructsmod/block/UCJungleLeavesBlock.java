...
public class UCJungleLeavesBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jungle_leaves")
	public static final Block block = null;

	public UCJungleLeavesBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 288);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_jungle_leaves");
		}
