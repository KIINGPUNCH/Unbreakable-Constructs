...
public class UCShroomlightBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_shroomlight")
	public static final Block block = null;

	public UCShroomlightBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 380);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.SHROOMLIGHT).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 15));
			setRegistryName("uc_shroomlight");
		}
