...
public class UCRedStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_red_stained_glass_pane")
	public static final Block block = null;

	public UCRedStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 336);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_red_stained_glass_pane");
		}
