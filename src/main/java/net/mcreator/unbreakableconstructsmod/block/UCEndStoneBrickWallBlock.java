...
public class UCEndStoneBrickWallBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_end_stone_brick_wall")
	public static final Block block = null;

	public UCEndStoneBrickWallBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 316);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_end_stone_brick_wall");
		}
