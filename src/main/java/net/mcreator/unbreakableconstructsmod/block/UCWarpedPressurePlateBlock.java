...
public class UCWarpedPressurePlateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_warped_pressure_plate")
	public static final Block block = null;

	public UCWarpedPressurePlateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 407);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_warped_pressure_plate");
		}
