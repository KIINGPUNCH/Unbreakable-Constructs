...
public class UCBlackWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_black_wool")
	public static final Block block = null;

	public UCBlackWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 69);
	}
