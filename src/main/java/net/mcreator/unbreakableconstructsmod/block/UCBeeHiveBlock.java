...
public class UCBeeHiveBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_bee_hive")
	public static final Block block = null;

	public UCBeeHiveBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 383);
	}
