...
public class UCBirchLeavesBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_birch_leaves")
	public static final Block block = null;

	public UCBirchLeavesBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 287);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_birch_leaves");
		}
