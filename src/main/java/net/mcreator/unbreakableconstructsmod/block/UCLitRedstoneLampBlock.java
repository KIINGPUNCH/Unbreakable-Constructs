...
public class UCLitRedstoneLampBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lit_redstone_lamp")
	public static final Block block = null;

	public UCLitRedstoneLampBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 426);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.GLASS).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 15));
			setRegistryName("uc_lit_redstone_lamp");
		}
