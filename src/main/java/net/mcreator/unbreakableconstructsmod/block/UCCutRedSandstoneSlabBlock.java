...
public class UCCutRedSandstoneSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_cut_red_sandstone_slab")
	public static final Block block = null;

	public UCCutRedSandstoneSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_cut_red_sandstone_slab");
		}
