...
public class UCPistonBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_piston")
	public static final Block block = null;

	public UCPistonBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 397);
	}
