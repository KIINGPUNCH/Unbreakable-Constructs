...
public class UCNetherBrickSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_nether_brick_slab")
	public static final Block block = null;

	public UCNetherBrickSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.NETHER_BRICK).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_nether_brick_slab");
		}
