...
public class UCDarkOakTrapdoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dark_oak_trapdoor")
	public static final Block block = null;

	public UCDarkOakTrapdoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 414);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_dark_oak_trapdoor");
		}
