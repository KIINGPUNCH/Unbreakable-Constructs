...
public class UCEmeraldOreBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_emerald_ore")
	public static final Block block = null;

	public UCEmeraldOreBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_emerald_ore");
		}
