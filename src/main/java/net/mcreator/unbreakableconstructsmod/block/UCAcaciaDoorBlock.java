...
public class UCAcaciaDoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_acacia_door")
	public static final Block block = null;

	public UCAcaciaDoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 449);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_acacia_door");
		}
