...
public class UCPurpleStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_purple_stained_glass_pane")
	public static final Block block = null;

	public UCPurpleStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 332);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_purple_stained_glass_pane");
		}
