...
public class UCCyanWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_cyan_wool")
	public static final Block block = null;

	public UCCyanWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 63);
	}
