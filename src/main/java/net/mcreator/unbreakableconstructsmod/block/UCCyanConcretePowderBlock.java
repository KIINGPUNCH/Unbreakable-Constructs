...
public class UCCyanConcretePowderBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_cyan_concrete_powder")
	public static final Block block = null;

	public UCCyanConcretePowderBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 226);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.SAND).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_cyan_concrete_powder");
		}
