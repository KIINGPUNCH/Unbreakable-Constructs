...
public class UCOakLeavesBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_leaves")
	public static final Block block = null;

	public UCOakLeavesBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 285);
