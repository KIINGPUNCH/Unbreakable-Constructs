...
public class UCCommandBlockConditionalBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_command_block_conditional")
	public static final Block block = null;

	public UCCommandBlockConditionalBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 456);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_command_block_conditional");
		}
