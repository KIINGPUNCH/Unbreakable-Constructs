...
public class UCBlockofGoldBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blockof_gold")
	public static final Block block = null;

	public UCBlockofGoldBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.METAL).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_blockof_gold");
		}
