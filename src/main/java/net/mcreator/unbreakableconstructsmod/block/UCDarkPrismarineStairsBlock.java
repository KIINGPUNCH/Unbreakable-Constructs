...
public class UCDarkPrismarineStairsBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dark_prismarine_stairs")
	public static final Block block = null;

	public UCDarkPrismarineStairsBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 190);
	}
		...
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE)
					...
					Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
							.setLightLevel(s -> 0));
			setRegistryName("uc_dark_prismarine_stairs");
		}
