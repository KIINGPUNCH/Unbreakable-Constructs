...
public class UCCoalOreBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_coal_ore")
	public static final Block block = null;

	public UCCoalOreBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 28);
	}
