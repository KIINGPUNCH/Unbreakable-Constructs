...
public class UCDispenserVerticalBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dispenser_vertical")
	public static final Block block = null;

	public UCDispenserVerticalBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 394);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_dispenser_vertical");
		}
