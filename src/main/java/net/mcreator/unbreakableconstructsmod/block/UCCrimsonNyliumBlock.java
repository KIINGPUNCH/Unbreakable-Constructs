...
public class UCCrimsonNyliumBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_crimson_nylium")
	public static final Block block = null;

	public UCCrimsonNyliumBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.NYLIUM).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_crimson_nylium");
		}
