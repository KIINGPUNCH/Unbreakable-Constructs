...
public class UCSmithingTableBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_smithing_table")
	public static final Block block = null;

	public UCSmithingTableBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 379);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_smithing_table");
		}
