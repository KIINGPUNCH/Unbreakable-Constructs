...
public class UCBirchTrapdoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_birch_trapdoor")
	public static final Block block = null;

	public UCBirchTrapdoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 411);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_birch_trapdoor");
		}
