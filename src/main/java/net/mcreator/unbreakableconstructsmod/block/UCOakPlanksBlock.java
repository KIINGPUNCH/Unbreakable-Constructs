...
public class UCOakPlanksBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_planks")
	public static final Block block = null;

	public UCOakPlanksBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 15);
	}
