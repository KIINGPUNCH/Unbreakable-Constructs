...
public class UCDispenserBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dispenser")
	public static final Block block = null;

	public UCDispenserBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 393);
	}
