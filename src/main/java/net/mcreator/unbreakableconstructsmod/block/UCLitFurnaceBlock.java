...
public class UCLitFurnaceBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lit_furnace")
	public static final Block block = null;

	public UCLitFurnaceBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 292);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_lit_furnace");
		}
