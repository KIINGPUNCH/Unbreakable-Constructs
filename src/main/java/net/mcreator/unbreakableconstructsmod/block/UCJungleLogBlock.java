...
public class UCJungleLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jungle_log")
	public static final Block block = null;

	public UCJungleLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 33);
	}
