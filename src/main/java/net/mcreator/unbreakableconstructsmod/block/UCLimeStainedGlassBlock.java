...
public class UCLimeStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lime_stained_glass")
	public static final Block block = null;

	public UCLimeStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_lime_stained_glass");
		}
