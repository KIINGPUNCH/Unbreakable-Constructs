...
public class UCGrassBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_grass_block")
	public static final Block block = null;

	public UCGrassBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.GROUND).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_grass_block");
		}
