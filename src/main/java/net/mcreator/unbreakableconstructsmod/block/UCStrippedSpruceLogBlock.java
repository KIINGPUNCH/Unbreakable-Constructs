...
public class UCStrippedSpruceLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stripped_spruce_log")
	public static final Block block = null;

	public UCStrippedSpruceLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_stripped_spruce_log");
		}
