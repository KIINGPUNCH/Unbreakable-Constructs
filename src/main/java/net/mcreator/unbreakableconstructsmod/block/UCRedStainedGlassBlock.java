...
public class UCRedStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_red_stained_glass")
	public static final Block block = null;

	public UCRedStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 183);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_red_stained_glass");
		}
