...
public class UCBlackstoneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blackstone")
	public static final Block block = null;

	public UCBlackstoneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 273);
	}
