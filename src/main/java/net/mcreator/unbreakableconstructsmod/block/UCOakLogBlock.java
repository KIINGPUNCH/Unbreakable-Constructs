...
public class UCOakLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_log")
	public static final Block block = null;

	public UCOakLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 30);
	}
