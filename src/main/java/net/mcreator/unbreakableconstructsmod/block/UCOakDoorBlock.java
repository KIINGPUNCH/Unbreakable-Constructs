...
public class UCOakDoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_door")
	public static final Block block = null;

	public UCOakDoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 445);
	}
