...
public class UCAcaciaSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_acacia_slab")
	public static final Block block = null;

	public UCAcaciaSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_acacia_slab");
		}
