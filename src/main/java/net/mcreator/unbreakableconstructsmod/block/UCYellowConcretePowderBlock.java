...
public class UCYellowConcretePowderBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_yellow_concrete_powder")
	public static final Block block = null;

	public UCYellowConcretePowderBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 221);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.SAND).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_yellow_concrete_powder");
		}
