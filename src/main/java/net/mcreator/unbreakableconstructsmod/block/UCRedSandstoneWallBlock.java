...
public class UCRedSandstoneWallBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_red_sandstone_wall")
	public static final Block block = null;

	public UCRedSandstoneWallBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 310);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_red_sandstone_wall");
		}
