...
public class UCBlackStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_black_stained_glass")
	public static final Block block = null;

	public UCBlackStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 184);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_black_stained_glass");
		}
