...
public class UCJungleButtonBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jungle_button")
	public static final Block block = null;

	public UCJungleButtonBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 431);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_jungle_button");
		}
