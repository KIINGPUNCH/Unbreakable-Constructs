...
public class UCStrippedDarkOakLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stripped_dark_oak_log")
	public static final Block block = null;

	public UCStrippedDarkOakLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_stripped_dark_oak_log");
		}
