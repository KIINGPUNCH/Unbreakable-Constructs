...
public class UCBlueConcretePowderBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blue_concrete_powder")
	public static final Block block = null;

	public UCBlueConcretePowderBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 228);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.SAND).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_blue_concrete_powder");
		}
