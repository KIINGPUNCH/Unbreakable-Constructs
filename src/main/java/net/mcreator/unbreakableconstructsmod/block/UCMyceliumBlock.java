...
public class UCMyceliumBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_mycelium")
	public static final Block block = null;

	public UCMyceliumBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 127);
	}
