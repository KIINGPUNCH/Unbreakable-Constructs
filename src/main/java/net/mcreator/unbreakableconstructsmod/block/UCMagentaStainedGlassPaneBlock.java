...
public class UCMagentaStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_magenta_stained_glass_pane")
	public static final Block block = null;

	public UCMagentaStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 324);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_magenta_stained_glass_pane");
		}
