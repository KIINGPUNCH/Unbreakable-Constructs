...
public class UCSandBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_sand")
	public static final Block block = null;

	public UCSandBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 23);
	}
