...
public class UCCraftingTableBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_crafting_table")
	public static final Block block = null;

	public UCCraftingTableBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 291);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_crafting_table");
		}
