...
public class UCPrismarineBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_prismarine")
	public static final Block block = null;

	public UCPrismarineBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 185);
	}
