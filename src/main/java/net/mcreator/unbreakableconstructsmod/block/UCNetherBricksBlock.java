...
public class UCNetherBricksBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_nether_bricks")
	public static final Block block = null;

	public UCNetherBricksBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.NETHER_BRICK).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_nether_bricks");
		}
