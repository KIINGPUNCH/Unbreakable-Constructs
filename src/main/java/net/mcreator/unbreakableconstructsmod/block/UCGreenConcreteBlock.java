...
public class UCGreenConcreteBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_green_concrete")
	public static final Block block = null;

	public UCGreenConcreteBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 214);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_green_concrete");
		}
