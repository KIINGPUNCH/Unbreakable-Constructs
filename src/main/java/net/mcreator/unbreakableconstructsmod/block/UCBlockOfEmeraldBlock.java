...
public class UCBlockOfEmeraldBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_block_of_emerald")
	public static final Block block = null;

	public UCBlockOfEmeraldBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.METAL).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_block_of_emerald");
		}
