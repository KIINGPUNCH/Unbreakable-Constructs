...
public class UCFurnaceBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_furnace")
	public static final Block block = null;

	public UCFurnaceBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 293);
	}
