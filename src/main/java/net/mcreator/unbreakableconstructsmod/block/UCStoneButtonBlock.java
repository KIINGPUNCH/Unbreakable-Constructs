...
public class UCStoneButtonBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stone_button")
	public static final Block block = null;

	public UCStoneButtonBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 427);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_stone_button");
		}
