...
public class UCWarpedStemBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_warped_stem")
	public static final Block block = null;

	public UCWarpedStemBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_warped_stem");
		}
