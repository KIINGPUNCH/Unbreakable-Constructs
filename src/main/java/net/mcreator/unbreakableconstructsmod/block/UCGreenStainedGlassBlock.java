...
public class UCGreenStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_green_stained_glass")
	public static final Block block = null;

	public UCGreenStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 182);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_green_stained_glass");
		}
