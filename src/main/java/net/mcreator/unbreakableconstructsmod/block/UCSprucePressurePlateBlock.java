...
public class UCSprucePressurePlateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_spruce_pressure_plate")
	public static final Block block = null;

	public UCSprucePressurePlateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 401);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_spruce_pressure_plate");
		}
