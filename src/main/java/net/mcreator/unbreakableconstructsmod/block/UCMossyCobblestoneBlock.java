...
public class UCMossyCobblestoneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_mossy_cobblestone")
	public static final Block block = null;

	public UCMossyCobblestoneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_mossy_cobblestone");
		}
