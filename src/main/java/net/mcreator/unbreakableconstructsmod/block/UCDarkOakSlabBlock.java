...
public class UCDarkOakSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dark_oak_slab")
	public static final Block block = null;

	public UCDarkOakSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_dark_oak_slab");
		}
