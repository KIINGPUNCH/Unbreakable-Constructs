...
public class UCAcaciaFenceGateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_acacia_fence_gate")
	public static final Block block = null;

	public UCAcaciaFenceGateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 421);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_acacia_fence_gate");
		}
