...
public class UCSpruceTrapdoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_spruce_trapdoor")
	public static final Block block = null;

	public UCSpruceTrapdoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 410);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_spruce_trapdoor");
		}
