...
public class UCOakFenceGateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_fence_gate")
	public static final Block block = null;

	public UCOakFenceGateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 417);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_oak_fence_gate");
		}
