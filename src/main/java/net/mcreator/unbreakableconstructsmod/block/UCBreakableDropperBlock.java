...
public class UCBreakableDropperBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_breakable_dropper")
	public static final Block block = null;

	public UCBreakableDropperBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 471);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_breakable_dropper");
		}
