...
public class UCPinkStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_pink_stained_glass")
	public static final Block block = null;

	public UCPinkStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 175);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_pink_stained_glass");
		}
