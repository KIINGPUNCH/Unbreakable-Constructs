...
public class UCAcaciaFenceBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_acacia_fence")
	public static final Block block = null;

	public UCAcaciaFenceBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_acacia_fence");
		}
