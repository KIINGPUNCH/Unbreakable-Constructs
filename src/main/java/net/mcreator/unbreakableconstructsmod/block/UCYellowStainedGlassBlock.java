...
public class UCYellowStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_yellow_stained_glass")
	public static final Block block = null;

	public UCYellowStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_yellow_stained_glass");
		}
