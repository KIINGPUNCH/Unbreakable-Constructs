...
public class UCGraniteWallBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_granite_wall")
	public static final Block block = null;

	public UCGraniteWallBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 312);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_granite_wall");
		}
