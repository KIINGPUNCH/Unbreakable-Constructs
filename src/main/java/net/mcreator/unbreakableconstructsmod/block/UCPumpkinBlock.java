...
public class UCPumpkinBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_pumpkin")
	public static final Block block = null;

	public UCPumpkinBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 111);
	}
