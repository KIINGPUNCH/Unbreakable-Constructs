...
public class UCJungleStairsBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jungle_stairs")
	public static final Block block = null;

	public UCJungleStairsBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 138);
	}
		...
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD)
					...
					Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
							.setLightLevel(s -> 0));
			setRegistryName("uc_jungle_stairs");
		}
