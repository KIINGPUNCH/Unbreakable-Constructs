...
public class UCStrippedAcaciaLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stripped_acacia_log")
	public static final Block block = null;

	public UCStrippedAcaciaLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_stripped_acacia_log");
		}
