...
public class UCSpruceLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_spruce_log")
	public static final Block block = null;

	public UCSpruceLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 31);
	}
