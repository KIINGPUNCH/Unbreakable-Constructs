...
public class UCBeeNestHoneyBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_bee_nest_honey")
	public static final Block block = null;

	public UCBeeNestHoneyBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 382);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_bee_nest_honey");
		}
