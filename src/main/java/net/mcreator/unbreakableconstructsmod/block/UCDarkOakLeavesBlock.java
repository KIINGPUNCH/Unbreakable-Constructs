...
public class UCDarkOakLeavesBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dark_oak_leaves")
	public static final Block block = null;

	public UCDarkOakLeavesBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 290);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES, MaterialColor.AIR).sound(SoundType.PLANT).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0).notSolid());
			setRegistryName("uc_dark_oak_leaves");
		}
