...
public class UCOrangeStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_orange_stained_glass_pane")
	public static final Block block = null;

	public UCOrangeStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 323);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_orange_stained_glass_pane");
		}
