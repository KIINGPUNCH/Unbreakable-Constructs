...
public class UCAncientDebrisBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_ancient_debris")
	public static final Block block = null;

	public UCAncientDebrisBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 271);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.ANCIENT_DEBRIS).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_ancient_debris");
		}
