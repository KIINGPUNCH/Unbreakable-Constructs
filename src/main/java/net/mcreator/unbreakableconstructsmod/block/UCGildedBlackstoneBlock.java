...
public class UCGildedBlackstoneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_gilded_blackstone")
	public static final Block block = null;

	public UCGildedBlackstoneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 276);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_gilded_blackstone");
		}
