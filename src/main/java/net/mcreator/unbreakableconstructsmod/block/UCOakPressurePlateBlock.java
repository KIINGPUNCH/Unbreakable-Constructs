...
public class UCOakPressurePlateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_pressure_plate")
	public static final Block block = null;

	public UCOakPressurePlateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 400);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_oak_pressure_plate");
		}
