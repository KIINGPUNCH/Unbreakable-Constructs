...
public class UCGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_glass")
	public static final Block block = null;

	public UCGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 48);
	}
