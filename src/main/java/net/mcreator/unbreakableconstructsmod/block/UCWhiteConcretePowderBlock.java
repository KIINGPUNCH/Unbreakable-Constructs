...
public class UCWhiteConcretePowderBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_white_concrete_powder")
	public static final Block block = null;

	public UCWhiteConcretePowderBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 217);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.SAND).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_white_concrete_powder");
		}
