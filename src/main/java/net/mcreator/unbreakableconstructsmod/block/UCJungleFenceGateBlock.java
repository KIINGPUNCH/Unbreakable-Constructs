...
public class UCJungleFenceGateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jungle_fence_gate")
	public static final Block block = null;

	public UCJungleFenceGateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 420);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_jungle_fence_gate");
		}
