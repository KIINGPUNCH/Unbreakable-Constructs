...
public class UCHoneycombBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_honeycomb_block")
	public static final Block block = null;

	public UCHoneycombBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 386);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.HONEY).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_honeycomb_block");
		}
