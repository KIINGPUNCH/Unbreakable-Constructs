...
public class UCAcaciaPressurePlateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_acacia_pressure_plate")
	public static final Block block = null;

	public UCAcaciaPressurePlateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 404);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_acacia_pressure_plate");
		}
