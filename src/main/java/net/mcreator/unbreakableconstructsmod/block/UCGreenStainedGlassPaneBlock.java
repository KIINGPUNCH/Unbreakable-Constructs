...
public class UCGreenStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_green_stained_glass_pane")
	public static final Block block = null;

	public UCGreenStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 335);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_green_stained_glass_pane");
		}
