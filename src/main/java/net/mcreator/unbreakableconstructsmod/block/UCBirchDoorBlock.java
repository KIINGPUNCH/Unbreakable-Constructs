...
public class UCBirchDoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_birch_door")
	public static final Block block = null;

	public UCBirchDoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 447);
	}
