...
public class UCWarpedFenceBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_warped_fence")
	public static final Block block = null;

	public UCWarpedFenceBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 302);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_warped_fence");
		}
