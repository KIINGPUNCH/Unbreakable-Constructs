...
public class UCCyanStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_cyan_stained_glass")
	public static final Block block = null;

	public UCCyanStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_cyan_stained_glass");
		}
