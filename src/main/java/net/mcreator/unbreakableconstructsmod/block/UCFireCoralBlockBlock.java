...
public class UCFireCoralBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_fire_coral_block")
	public static final Block block = null;

	public UCFireCoralBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 241);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.CORAL).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_fire_coral_block");
		}
