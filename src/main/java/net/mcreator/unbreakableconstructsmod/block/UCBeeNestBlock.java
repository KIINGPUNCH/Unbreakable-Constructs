...
public class UCBeeNestBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_bee_nest")
	public static final Block block = null;

	public UCBeeNestBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 381);
	}
