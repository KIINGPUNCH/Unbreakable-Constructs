...
public class UCOakFenceBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_fence")
	public static final Block block = null;

	public UCOakFenceBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 295);
	}
