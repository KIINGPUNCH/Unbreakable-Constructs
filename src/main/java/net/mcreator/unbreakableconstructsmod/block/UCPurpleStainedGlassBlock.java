...
public class UCPurpleStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_purple_stained_glass")
	public static final Block block = null;

	public UCPurpleStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_purple_stained_glass");
		}
