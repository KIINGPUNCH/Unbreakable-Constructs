...
public class UCPinkConcreteBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_pink_concrete")
	public static final Block block = null;

	public UCPinkConcreteBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 207);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_pink_concrete");
		}
