...
public class UCPolishedAndesiteBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_polished_andesite")
	public static final Block block = null;

	public UCPolishedAndesiteBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_polished_andesite");
		}
