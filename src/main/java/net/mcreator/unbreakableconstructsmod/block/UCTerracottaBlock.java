...
public class UCTerracottaBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_terracotta")
	public static final Block block = null;

	public UCTerracottaBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 164);
	}
