...
public class UCSpruceDoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_spruce_door")
	public static final Block block = null;

	public UCSpruceDoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 446);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_spruce_door");
		}
