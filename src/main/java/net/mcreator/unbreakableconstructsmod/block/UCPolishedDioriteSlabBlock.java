...
public class UCPolishedDioriteSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_polished_diorite_slab")
	public static final Block block = null;

	public UCPolishedDioriteSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 259);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_polished_diorite_slab");
		}
