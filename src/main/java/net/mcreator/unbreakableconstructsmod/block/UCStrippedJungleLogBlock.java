...
public class UCStrippedJungleLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stripped_jungle_log")
	public static final Block block = null;

	public UCStrippedJungleLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_stripped_jungle_log");
		}
