...
public class UCOakTrapdoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_oak_trapdoor")
	public static final Block block = null;

	public UCOakTrapdoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 409);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_oak_trapdoor");
		}
