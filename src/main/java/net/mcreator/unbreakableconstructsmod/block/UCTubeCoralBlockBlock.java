...
public class UCTubeCoralBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_tube_coral_block")
	public static final Block block = null;

	public UCTubeCoralBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 238);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.CORAL).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_tube_coral_block");
		}
