...
public class UCLitRespawnAnchor2Block extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lit_respawn_anchor_2")
	public static final Block block = null;

	public UCLitRespawnAnchor2Block(UnbreakableConstructsModModElements instance) {
		super(instance, 390);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 7));
			setRegistryName("uc_lit_respawn_anchor_2");
		}
