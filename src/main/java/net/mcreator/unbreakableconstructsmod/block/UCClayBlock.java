...
public class UCClayBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_clay")
	public static final Block block = null;

	public UCClayBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 110);
	}
