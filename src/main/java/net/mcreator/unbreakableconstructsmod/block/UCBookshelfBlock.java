...
public class UCBookshelfBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_bookshelf")
	public static final Block block = null;

	public UCBookshelfBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 97);
	}
