...
public class UCDiamondOreBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_diamond_ore")
	public static final Block block = null;

	public UCDiamondOreBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_diamond_ore");
		}
