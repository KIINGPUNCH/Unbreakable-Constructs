...
public class UCGrayStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_gray_stained_glass")
	public static final Block block = null;

	public UCGrayStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_gray_stained_glass");
		}
