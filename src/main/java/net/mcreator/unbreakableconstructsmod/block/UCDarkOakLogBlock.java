...
public class UCDarkOakLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dark_oak_log")
	public static final Block block = null;

	public UCDarkOakLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_dark_oak_log");
		}
