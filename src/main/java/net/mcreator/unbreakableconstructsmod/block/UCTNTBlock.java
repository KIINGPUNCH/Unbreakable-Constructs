...
public class UCTNTBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uctnt")
	public static final Block block = null;

	public UCTNTBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 398);
	}
