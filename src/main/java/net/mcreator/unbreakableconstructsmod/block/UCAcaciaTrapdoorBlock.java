...
public class UCAcaciaTrapdoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_acacia_trapdoor")
	public static final Block block = null;

	public UCAcaciaTrapdoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 413);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_acacia_trapdoor");
		}
