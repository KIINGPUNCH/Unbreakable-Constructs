...
public class UCLodestoneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lodestone")
	public static final Block block = null;

	public UCLodestoneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 387);
	}
