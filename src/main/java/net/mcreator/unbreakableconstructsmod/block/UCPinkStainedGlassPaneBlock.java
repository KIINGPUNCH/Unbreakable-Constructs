...
public class UCPinkStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_pink_stained_glass_pane")
	public static final Block block = null;

	public UCPinkStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 328);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_pink_stained_glass_pane");
		}
