...
public class UCNetherGoldOreBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_nether_gold_ore")
	public static final Block block = null;

	public UCNetherGoldOreBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.NETHERRACK).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_nether_gold_ore");
		}
