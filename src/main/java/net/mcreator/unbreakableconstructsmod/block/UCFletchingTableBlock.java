...
public class UCFletchingTableBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_fletching_table")
	public static final Block block = null;

	public UCFletchingTableBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 378);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_fletching_table");
		}
