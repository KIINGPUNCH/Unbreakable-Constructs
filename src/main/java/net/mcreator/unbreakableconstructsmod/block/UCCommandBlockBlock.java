...
public class UCCommandBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_command_block")
	public static final Block block = null;

	public UCCommandBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 455);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_command_block");
		}
