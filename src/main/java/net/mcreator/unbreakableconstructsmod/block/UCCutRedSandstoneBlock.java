...
public class UCCutRedSandstoneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_cut_red_sandstone")
	public static final Block block = null;

	public UCCutRedSandstoneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_cut_red_sandstone");
		}
