...
public class UCAcaciaLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_acacia_log")
	public static final Block block = null;

	public UCAcaciaLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 34);
	}
