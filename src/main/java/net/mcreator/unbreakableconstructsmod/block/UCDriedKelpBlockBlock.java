...
public class UCDriedKelpBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dried_kelp_block")
	public static final Block block = null;

	public UCDriedKelpBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.GROUND).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_dried_kelp_block");
		}
