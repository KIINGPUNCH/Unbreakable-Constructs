...
public class UCChiseledRedSandstoneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_chiseled_red_sandstone")
	public static final Block block = null;

	public UCChiseledRedSandstoneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 193);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_chiseled_red_sandstone");
		}
