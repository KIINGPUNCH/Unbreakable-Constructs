...
public class UCGreenWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_green_wool")
	public static final Block block = null;

	public UCGreenWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 67);
	}
