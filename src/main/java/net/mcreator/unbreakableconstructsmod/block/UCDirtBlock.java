...
public class UCDirtBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dirt")
	public static final Block block = null;

	public UCDirtBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 9);
	}
