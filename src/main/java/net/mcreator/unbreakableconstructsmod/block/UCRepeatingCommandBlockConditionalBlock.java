...
public class UCRepeatingCommandBlockConditionalBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_repeating_command_block_conditional")
	public static final Block block = null;

	public UCRepeatingCommandBlockConditionalBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 460);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_repeating_command_block_conditional");
		}
