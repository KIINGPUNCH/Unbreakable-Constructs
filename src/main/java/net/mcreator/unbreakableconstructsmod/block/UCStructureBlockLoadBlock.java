...
public class UCStructureBlockLoadBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_structure_block_load")
	public static final Block block = null;

	public UCStructureBlockLoadBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 464);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_structure_block_load");
		}
