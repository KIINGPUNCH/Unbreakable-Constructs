...
public class UCIronDoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_iron_door")
	public static final Block block = null;

	public UCIronDoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 444);
	}
