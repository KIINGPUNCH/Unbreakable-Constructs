...
public class UCStrippedCrimsonStemBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stripped_crimson_stem")
	public static final Block block = null;

	public UCStrippedCrimsonStemBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.HYPHAE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("uc_stripped_crimson_stem");
		}
