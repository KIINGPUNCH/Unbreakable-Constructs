...
public class UCNetherBrickWallBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_nether_brick_wall")
	public static final Block block = null;

	public UCNetherBrickWallBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 314);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.NETHER_BRICK).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_nether_brick_wall");
		}
