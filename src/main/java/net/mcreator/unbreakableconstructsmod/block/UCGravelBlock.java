...
public class UCGravelBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_gravel")
	public static final Block block = null;

	public UCGravelBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 25);
	}
