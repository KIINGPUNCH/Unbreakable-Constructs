...
public class UCStructureBlockCornerBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_structure_block_corner")
	public static final Block block = null;

	public UCStructureBlockCornerBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 462);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_structure_block_corner");
		}
