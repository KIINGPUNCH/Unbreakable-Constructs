...
public class UCLitSmokerBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lit_smoker")
	public static final Block block = null;

	public UCLitSmokerBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 374);
	}
