...
public class UCBlueStainedGlassBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blue_stained_glass")
	public static final Block block = null;

	public UCBlueStainedGlassBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uc_blue_stained_glass");
		}
