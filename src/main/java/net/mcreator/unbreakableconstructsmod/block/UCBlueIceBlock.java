...
public class UCBlueIceBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_blue_ice")
	public static final Block block = null;

	public UCBlueIceBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 243);
	}
