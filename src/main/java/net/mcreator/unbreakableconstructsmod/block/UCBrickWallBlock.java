...
public class UCBrickWallBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_brick_wall")
	public static final Block block = null;

	public UCBrickWallBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 308);
	}
