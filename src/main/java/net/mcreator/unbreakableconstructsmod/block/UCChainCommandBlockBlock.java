...
public class UCChainCommandBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_chain_command_block")
	public static final Block block = null;

	public UCChainCommandBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 457);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_chain_command_block");
		}
