...
public class UCJungleDoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jungle_door")
	public static final Block block = null;

	public UCJungleDoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 448);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_jungle_door");
		}
