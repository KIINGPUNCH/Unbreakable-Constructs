...
public class UCDarkPrismarineBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dark_prismarine")
	public static final Block block = null;

	public UCDarkPrismarineBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_dark_prismarine");
		}
