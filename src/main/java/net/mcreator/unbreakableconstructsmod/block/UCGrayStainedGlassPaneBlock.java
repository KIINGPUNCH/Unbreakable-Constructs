...
public class UCGrayStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_gray_stained_glass_pane")
	public static final Block block = null;

	public UCGrayStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 329);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_gray_stained_glass_pane");
		}
