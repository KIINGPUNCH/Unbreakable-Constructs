...
public class UCAcaciaLeavesBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_acacia_leaves")
	public static final Block block = null;

	public UCAcaciaLeavesBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 289);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_acacia_leaves");
		}
