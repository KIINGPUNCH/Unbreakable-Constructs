...
public class UCCrimsonStemBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_crimson_stem")
	public static final Block block = null;

	public UCCrimsonStemBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_crimson_stem");
		}
