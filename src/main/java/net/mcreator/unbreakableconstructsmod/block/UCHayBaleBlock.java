...
public class UCHayBaleBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_hay_bale")
	public static final Block block = null;

	public UCHayBaleBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 163);
	}
