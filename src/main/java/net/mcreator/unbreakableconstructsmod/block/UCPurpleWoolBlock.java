...
public class UCPurpleWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_purple_wool")
	public static final Block block = null;

	public UCPurpleWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.CLOTH).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_purple_wool");
		}
