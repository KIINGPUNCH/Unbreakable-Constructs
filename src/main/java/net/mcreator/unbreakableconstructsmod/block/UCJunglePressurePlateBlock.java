...
public class UCJunglePressurePlateBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jungle_pressure_plate")
	public static final Block block = null;

	public UCJunglePressurePlateBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 403);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_jungle_pressure_plate");
		}
