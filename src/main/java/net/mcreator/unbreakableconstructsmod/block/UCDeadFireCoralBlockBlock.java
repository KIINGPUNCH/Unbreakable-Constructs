...
public class UCDeadFireCoralBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dead_fire_coral_block")
	public static final Block block = null;

	public UCDeadFireCoralBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 236);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_dead_fire_coral_block");
		}
