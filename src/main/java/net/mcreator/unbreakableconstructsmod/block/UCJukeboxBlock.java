...
public class UCJukeboxBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jukebox")
	public static final Block block = null;

	public UCJukeboxBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 294);
	}
