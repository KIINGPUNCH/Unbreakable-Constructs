...
public class UCBlockOfCoalBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_block_of_coal")
	public static final Block block = null;

	public UCBlockOfCoalBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 165);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_block_of_coal");
		}
