...
public class UCAndesiteStairsBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_andesite_stairs")
	public static final Block block = null;

	public UCAndesiteStairsBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 252);
	}
		...
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE)
					...
					Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
							.setLightLevel(s -> 0));
			setRegistryName("uc_andesite_stairs");
		}
