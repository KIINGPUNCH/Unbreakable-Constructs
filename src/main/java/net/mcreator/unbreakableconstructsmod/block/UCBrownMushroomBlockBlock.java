...
public class UCBrownMushroomBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_brown_mushroom_block")
	public static final Block block = null;

	public UCBrownMushroomBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 303);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.WOOD).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_brown_mushroom_block");
		}
