...
public class UCHornCoralBlockBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_horn_coral_block")
	public static final Block block = null;

	public UCHornCoralBlockBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 242);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.CORAL).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_horn_coral_block");
		}
