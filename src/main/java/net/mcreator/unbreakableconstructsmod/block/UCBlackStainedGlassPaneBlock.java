...
public class UCBlackStainedGlassPaneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_black_stained_glass_pane")
	public static final Block block = null;

	public UCBlackStainedGlassPaneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 337);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_black_stained_glass_pane");
		}
