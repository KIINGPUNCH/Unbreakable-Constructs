...
public class UCBrownGlazedTerracottaBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_brown_glazed_terracotta")
	public static final Block block = null;

	public UCBrownGlazedTerracottaBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 367);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_brown_glazed_terracotta");
		}
