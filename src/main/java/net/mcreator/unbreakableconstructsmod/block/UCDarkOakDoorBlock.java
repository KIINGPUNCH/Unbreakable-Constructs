...
public class UCDarkOakDoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_dark_oak_door")
	public static final Block block = null;

	public UCDarkOakDoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 450);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_dark_oak_door");
		}
