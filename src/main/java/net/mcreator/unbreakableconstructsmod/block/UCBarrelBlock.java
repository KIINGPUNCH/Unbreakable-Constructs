...
public class UCBarrelBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_barrel")
	public static final Block block = null;

	public UCBarrelBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 372);
	}
