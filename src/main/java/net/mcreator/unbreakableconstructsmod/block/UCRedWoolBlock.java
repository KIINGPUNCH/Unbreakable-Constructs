...
public class UCRedWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_red_wool")
	public static final Block block = null;

	public UCRedWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 68);
	}
