...
public class UCLimeWoolBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_lime_wool")
	public static final Block block = null;

	public UCLimeWoolBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 59);
	}
