...
public class UCCryingObsidianBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_crying_obsidian")
	public static final Block block = null;

	public UCCryingObsidianBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 272);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 10));
			setRegistryName("uc_crying_obsidian");
		}
