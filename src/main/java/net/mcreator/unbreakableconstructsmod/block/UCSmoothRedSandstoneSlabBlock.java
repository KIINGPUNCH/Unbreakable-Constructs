...
public class UCSmoothRedSandstoneSlabBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_smooth_red_sandstone_slab")
	public static final Block block = null;

	public UCSmoothRedSandstoneSlabBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 257);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_smooth_red_sandstone_slab");
		}
