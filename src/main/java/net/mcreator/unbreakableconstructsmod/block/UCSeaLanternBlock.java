...
public class UCSeaLanternBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_sea_lantern")
	public static final Block block = null;

	public UCSeaLanternBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.GLASS).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 15));
			setRegistryName("uc_sea_lantern");
		}
