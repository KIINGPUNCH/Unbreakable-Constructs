...
public class UCSmokerBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_smoker")
	public static final Block block = null;

	public UCSmokerBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 373);
	}
