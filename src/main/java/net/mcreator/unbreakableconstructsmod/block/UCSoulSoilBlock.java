...
public class UCSoulSoilBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_soul_soil")
	public static final Block block = null;

	public UCSoulSoilBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.SOUL_SOIL).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_soul_soil");
		}
