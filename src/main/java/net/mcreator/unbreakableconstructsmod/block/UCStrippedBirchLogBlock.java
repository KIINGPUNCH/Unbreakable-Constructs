...
public class UCStrippedBirchLogBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_stripped_birch_log")
	public static final Block block = null;

	public UCStrippedBirchLogBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_stripped_birch_log");
		}
