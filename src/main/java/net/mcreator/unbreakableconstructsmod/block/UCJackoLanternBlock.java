...
public class UCJackoLanternBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_jacko_lantern")
	public static final Block block = null;

	public UCJackoLanternBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("uc_jacko_lantern");
		}
