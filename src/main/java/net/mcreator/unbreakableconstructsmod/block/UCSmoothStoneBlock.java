...
public class UCSmoothStoneBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_smooth_stone")
	public static final Block block = null;

	public UCSmoothStoneBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_smooth_stone");
		}
