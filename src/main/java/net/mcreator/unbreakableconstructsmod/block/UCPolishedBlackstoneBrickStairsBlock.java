...
public class UCPolishedBlackstoneBrickStairsBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_polished_blackstone_brick_stairs")
	public static final Block block = null;

	public UCPolishedBlackstoneBrickStairsBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 283);
	}
		...
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE)
					...
					Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
							.setLightLevel(s -> 0));
			setRegistryName("uc_polished_blackstone_brick_stairs");
		}
