...
public class UCRespawnAnchorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_respawn_anchor")
	public static final Block block = null;

	public UCRespawnAnchorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 388);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.BARRIER, MaterialColor.AIR).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000)
					.setLightLevel(s -> 0));
			setRegistryName("uc_respawn_anchor");
		}
