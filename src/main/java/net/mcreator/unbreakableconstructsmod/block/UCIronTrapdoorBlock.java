...
public class UCIronTrapdoorBlock extends UnbreakableConstructsModModElements.ModElement {
	@ObjectHolder("unbreakable_constructs_mod:uc_iron_trapdoor")
	public static final Block block = null;

	public UCIronTrapdoorBlock(UnbreakableConstructsModModElements instance) {
		super(instance, 442);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("uc_iron_trapdoor");
		}
